...
// I am not sure if this is correct, or if we have to add the string
// max length, or ancestor from the Schema
...
// I am pretty sure following the set up of yesterdays
// code along that this will create a search function
// through all of the movements
const index = () => {
  let search = {};
