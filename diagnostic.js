...
// i think this might be right but I'm not really quite sure hos to test it. I tried running node diagnostic.js but I got an error.
// moving on for now and will try to circle back to it.
...
// I think I would insert an if else statement here to console log the not found error. I'm running out of time.
// I'm also not sure if I did all the Success and Failure msgs right.
};
